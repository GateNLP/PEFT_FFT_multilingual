...
from transformers import AdapterTrainer, AutoAdapterModel, EarlyStoppingCallback, IntervalStrategy
...
def objective(config):
    ...
    #     )
    my_adapter_config = HoulsbyConfig(reduction_factor=config["reduction_factor"])
...
fixed_config = {
    'output_dir': '/data3/gate/users/jaugusto97/xlmr-houlsby',
    ...
    'num_train_epochs': 30, 
    'batch_size': 8,
    'learning_rate': 0.00004300697708306946,
    'warmup_steps': 1987,
    'weight_decay': 0.00001538575256608497,
    'reduction_factor': 8 
}

def main():
    wandb.init(project='semeval-lora-rebuttal', name="houlsby", config=fixed_config)
